...
public class FlyingPathController {
	...
	/*
	 * @Autowired private AirportService airportServiceImpl;
	 */
	...
	public void flyingPathExcelDownloed(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			response.setHeader("Content-Disposition", "attachment;filename="
					.concat(String.valueOf(URLEncoder.encode("flyingpathTemplate.txt", "UTF-8"))));
...
//    }
	...
	// 路径航迹检查
	@RequestMapping(value = "/checkPlanePath", method = RequestMethod.GET)
	public String checkPlanePath(@RequestParam("id") int id, Model model) {
